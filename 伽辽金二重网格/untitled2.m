...
[boundary_nodes,~]=boundary_nodes_edges(trial_basis_type,num_of_element_r,num_of_element_c);
...
Xm(:,1)=inital_vector_u(P_trial(1,:)',P_trial(2,:)');
%初值条件（当前时间解向量）
...
for n=1:Nt+1
error_H1_u(n)=error_L2_assemble_2D(uhh(:,n),Ym(:,n),gauss_point, gauss_weight,P, T, T_trial, T_test, trial_basis_type, trial_basis_der_A_x1,trial_basis_der_A_y1)...
             +error_L2_assemble_2D(uhh(:,n),Ym(:,n),gauss_point, gauss_weight,P, T, T_trial, T_test, trial_basis_type, trial_basis_der_A_x2,trial_basis_der_A_y2);
